...
echo "
        ...
        <div class='justify-content-around py-5 px-3 mx-3 mt-5 bg-secondary text-light rounded'>
        ...
        <div class='mx-3 px-5 py-2 text-light rounded'><h3> Les Membres </h3></div>
        <div class='mx-3 d-flex justify-content-around text-light shadow-sm p-3 rounded'>
            <figure class='figure'>
